...
public class InterfaceService {
    ...
    /**
    * Retrieves all Interfaces attached to HOST @param as Dtos
    * 
    * @param hostId int
    * @return a list of intsDtos
    */    
    ...
    /**
    * Prepares an InterfaceDto obj from the passed interface obj
    * 
    * @param HibernateInterface interfaceObj
    * @return InterfaceDto
    */    
    @Transactional(readOnly = true)
    ...
    /**
    * Retrieves Interface by id @param
    * 
    * @param interfaceId int
    * @return a interfaceDto
    */    
    @Transactional(readOnly = true)
    ...
    /**
    * Retrieves Integer as hostid for interface id @param
    * 
    ...
    */    
    ...
    /**
    * Retrieves all Interfaces attached to HOST @param as Interfaces
    * 
    * @param hostId int
    ...
    */
    ...
    /**
    * Delete ONE interface - checks if teamed
    *
    * @return -
    */
    ...
    /**
    * Adds a new Interface and call method to set teaming ref to other interfaces @param
    * 
    * @param TeamedInterfaceDto teamedInterfaceDto
    * @return -
    */
    ...
    * 
    * @param Integer teamedInterfaceId - ID of new Team interface
    * @return -
    */    
    ...
    * 
    * @param List<Integer> interfaceList - list of interfaces to join team, Integer teamedInterfaceId - ID of new Team interface
    * @return -
    */    
