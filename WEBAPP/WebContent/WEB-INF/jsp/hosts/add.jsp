  ...
  <body>
    ...
    <div class="container">
      ...
      <h3>Create new host</h3>
        ...
        <c:url var="saveUrl" value="/hosts/add" />
        <form:form modelAttribute="hostAttribute" method="POST" action="${saveUrl}" class="form-horizontal">
            ...
            <div class="form-actions">
    			...
    			<a class="btn" href="${pageContext.request.contextPath}/hosts" title="Cancel">Cancel</a>
    		</div>
